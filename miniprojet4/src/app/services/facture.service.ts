...
export class FactureService {
  ...
  public getFactures():Observable<Facture[]>{
    return this.myhttp.get<Facture[]>("http://localhost:8093/Facture/Facture/retrieve-all-Factures");
  }
  public addFacture (f:Facture):Observable<Facture>
  {return this.myhttp.post<Facture>("http://localhost:8093/Facture/Facture/add-facture",f);}

  public deleteFacture(id:number){
    return this.myhttp.delete("http://localhost:8093/Facture/Facture/remove-facture/"+id);

  }
  public getFacture(id:number):Observable<Facture>{
    return this.myhttp.get<Facture>("http://localhost:8093/Facture/Facture/retrieve/"+id);
  }
  public UpdateFacture(f:Facture):Observable<Facture>{
    return this.myhttp.put<Facture>("http://localhost:8093/Facture/Facture/modify-facture",f);
  }
